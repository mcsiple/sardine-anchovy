...
load(here::here("R/Data/allsardineanchovy_3.RData"))# dataframe: alldat (raw data including NAs for missing years)
...
savetp3 <- tp3 %>% filter(!is.inf(log.diff))
#write.csv(savetp3,file = "PercentDiffsMarch2019.csv") # negative means anchovy is lower
